...
public class Exercise02 extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        btnReadExternal = (Button) findViewById(R.id.btnReadExternal);
        btnWriteInternal = (Button) findViewById(R.id.btnWriteInternal);
        btnWriteExternal = (Button) findViewById(R.id.btnWriteExternal);
    ...
    private void resetValue(String fileName) {
        edtContent.setText("");
        Toast.makeText(Exercise02.this, fileName + " saved to External Storage...", Toast.LENGTH_LONG).show();
    }
