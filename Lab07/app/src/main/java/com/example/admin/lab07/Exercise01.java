...
public class Exercise01 extends AppCompatActivity {
    ...
    private void displayValues() {
        ...
        Toast.makeText(this,"App startup times: " + appStartupTimes + " with username is " + username, Toast.LENGTH_LONG).show();
    }
    ...
    private void storePreferences() {
        ...
        editor.putString(SHARED_USER_NAME, "thChung");
        editor.apply();
        editor.commit();
    }
    ...
    private void getPreferences() {
        ...
        username = pre.getString(SHARED_USER_NAME, "No username found!!!");
    }
